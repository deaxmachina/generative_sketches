...
function checkDuplicatedImports(path) {
    ...
    if (chunks === null || chunks === void 0 ? void 0 : chunks.includes(path))
        return;
    chunks !== null && chunks !== void 0 ? chunks : (chunks = []);
    chunks.push(path);
 ...
 */
function default_1(source, shader, options) {
    const { defaultExtension, warnDuplicatedImports, compress } = options;
    resetSavedChunks();
    shader = loadChunks(source, shader, defaultExtension, warnDuplicatedImports);
