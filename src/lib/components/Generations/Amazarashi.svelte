...
<style lang="scss">
  ...
  @keyframes blur-animate {
    0% {
      filter: brightness(1.3) invert(0.17) saturate(2.6) sepia(0.25) blur(0px);
    }
    75% {
      filter: brightness(1.3) invert(0.17) saturate(2.6) sepia(0.25) blur(0px);
    }
    100% {
      filter: brightness(1.3) invert(0.17) saturate(2.6) sepia(0.25) blur(1px);
    }
  }
  #simple-cube-wrapper {
    width: 90%;
  ...
  #simple-cube-wrapper::before {
    ...
    width: 100%;
    height: 100%;
    filter: brightness(0.8) hue-rotate(350deg) saturate(3) blur(0px)
      contrast(0.6);
    //filter: brightness(1.3) invert(0.17) saturate(2.6) sepia(0.25) blur(8px);
    background-image: url("https://cdn.midjourney.com/e0767cc1-bcb0-4310-89d1-3b5591201d4c/0_0.png");
