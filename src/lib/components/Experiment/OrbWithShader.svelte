...
<style lang='scss'>
  ...
  @keyframes blur-animate {
    ...
    100% {filter: brightness(1.3) invert(0.17) saturate(2.6) sepia(0.25) blur(2px); }
  }
  #simple-cube-wrapper {
    width: 90%;
    max-width: 800px;
  ...
  #simple-cube-wrapper::before {
    ...
    background-image: url('https://mj-gallery.com/e414aa28-3ee6-4fc5-a72a-8d5264f711eb/grid_0.png');
