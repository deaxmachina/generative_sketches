...
import TrackballControlsExample from '../TrackballControlsExperiment/TrackballControlsExample.svelte';
  ...
  onMount(() => {
    ...
    // not available yet
    const wrapper = document.getElementById('amazarashi-landscape-wrapper')
...
<div on:click={setCols} class='wrapper' id='amazarashi-landscape-wrapper' bind:clientWidth="{widthContainer}" bind:clientHeight="{heightContainer}">
...
<style lang='scss'>
  ...
  #amazarashi-landscape-wrapper::before {
    content: "";
    position: absolute;
    top: 0; left: 0;
    width: 100%; 
    ...
    background-image: url('https://mj-gallery.com/bdc35458-a076-4149-9cdc-349b1e0da2e2/grid_0.png');
