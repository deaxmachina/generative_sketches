import { c as create_ssr_component, d as add_attribute, v as validate_component, f as add_styles, a as subscribe } from "./index-6c951edd.js";
...
const ShaderColours = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  let canvas;
...
<div class="${"wrapper svelte-n3luzd"}" id="${"shader-colours-wrapper"}"><canvas class="${"svelte-n3luzd"}"${add_attribute("this", canvas, 0)}></canvas>
</div>`;
});
...
const ShaderColours_1 = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  let col1;
  let col2;
  ...
  <div class="${"right svelte-air7lv"}">${validate_component(ShaderColours, "ShaderColours").$$render($$result, { col1, col2 }, {}, {})}</div>
</div>`;
});
...
<div class="${"wrapper svelte-1sx4h6r"}" id="${"rect-area-wrapper"}"><canvas class="${"svelte-1sx4h6r"}"${add_attribute("this", canvas, 0)}></canvas>
</div>`;
});
...
const RectAreaLight_1 = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  <div class="${"right svelte-air7lv"}">
    ${validate_component(RectAreaLight, "RectAreaLight").$$render($$result, {
    rectLightIntensity,
    rectLightWidth,
    rectLightHeight,
    noise2D
...
const ShaderShapes$2 = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  let canvas;
...
<div class="${"wrapper svelte-17hpy8e"}" id="${"shader-colours-wrapper"}"><canvas class="${"svelte-17hpy8e"}"${add_attribute("this", canvas, 0)}></canvas>
</div>`;
});
...
const ShaderShapes$1 = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  let colHills;
  let colSun;
  let hillValue;
  ...
  <div class="${"right svelte-1627w20"}">${validate_component(ShaderShapes$2, "ShaderColours").$$render($$result, { colHills, colSun, hillValue }, {}, {})}</div>
</div>`;
});
...
const ShaderShapes = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  let canvas;
  let { colHills = "#fff" } = $$props;
  let { hillValue = 0.5 } = $$props;
...
const ShaderShapes2 = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  let col1;
  let hillValue;
  $$result.css.add(css$6);
  return `<div class="${"layout svelte-air7lv"}"><div class="${"left svelte-air7lv"}"><h1 class="${"svelte-air7lv"}">Mercurial .02</h1>
    <button class="${"svelte-air7lv"}">re-generate</button></div>
  <div class="${"right svelte-air7lv"}">${validate_component(ShaderShapes, "ShaderColours").$$render($$result, { col1, hillValue }, {}, {})}</div>
</div>`;
});
...
const cameraZoom = 2;
const TrackballControlsExample = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  let width;
  let height;
  let aspect;
...
<div class="${"wrapper svelte-1j2hdhd"}" id="${"simple-cube-wrapper"}"><canvas class="${"svelte-1j2hdhd"}"${add_attribute("this", canvas, 0)}></canvas>
</div>`;
});
...
let colour = "#ffff";
const TrackballControlsExperiment = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  <div class="${"right svelte-xuaakt"}"${add_styles({ "max-width": `950px` })}>${validate_component(TrackballControlsExample, "TrackballControlsExample").$$render($$result, { colour, geometryType, backgroundColour }, {}, {})}</div>
</div>`;
});
...
const HemisphereLight$1 = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  let canvas;
...
<div class="${"wrapper svelte-qdett3"}" id="${"hemi-light-wrapper"}"><canvas class="${"svelte-qdett3"}"${add_attribute("this", canvas, 0)}></canvas>
</div>`;
});
...
const HemisphereLight_1 = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  let noise2DHemisphereLight = createNoise2D();
  $$result.css.add(css$2);
  return `<div class="${"layout svelte-1627w20"}">
  <div class="${"left svelte-1627w20"}"><h1 class="${"svelte-1627w20"}">Structured .01</h1>
    <button class="${"svelte-1627w20"}">re-generate</button></div>
  <div class="${"right svelte-1627w20"}">${validate_component(HemisphereLight$1, "HemisphereLight").$$render($$result, { noise2D: noise2DHemisphereLight }, {}, {})}</div>
</div>`;
});
...
const HemisphereLight = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  let canvas;
  let { noise2D = createNoise2D() } = $$props;
  if ($$props.noise2D === void 0 && $$bindings.noise2D && noise2D !== void 0)
    $$bindings.noise2D(noise2D);
...
const HemisphereLight2 = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  let noise2DHemisphereLight = createNoise2D();
  $$result.css.add(css);
  return `<div class="${"layout svelte-1627w20"}">
  <div class="${"left svelte-1627w20"}"><h1 class="${"svelte-1627w20"}">Structured .02</h1>
    <button class="${"svelte-1627w20"}">re-generate</button></div>
  <div class="${"right svelte-1627w20"}">${validate_component(HemisphereLight, "HemisphereLight").$$render($$result, { noise2D: noise2DHemisphereLight }, {}, {})}</div>
</div>`;
});
const Sketches = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `${$selectedWork === "colours01" ? `${validate_component(ShaderColours_1, "ShaderColours").$$render($$result, {}, {}, {})}` : `${$selectedWork === "light01" ? `${validate_component(RectAreaLight_1, "RectAreaLight1").$$render($$result, {}, {}, {})}` : `${$selectedWork === "mercurial01" ? `${validate_component(ShaderShapes$1, "ShaderShapes1").$$render($$result, {}, {}, {})}` : `${$selectedWork === "mercurial02" ? `${validate_component(ShaderShapes2, "ShaderShapes2").$$render($$result, {}, {}, {})}` : `${$selectedWork === "perspective01" ? `${validate_component(TrackballControlsExperiment, "TrackballControlsExample").$$render($$result, {}, {}, {})}` : `${$selectedWork === "structured01" ? `${validate_component(HemisphereLight_1, "HemisphereLight1").$$render($$result, {}, {}, {})}` : `${$selectedWork === "structured02" ? `${validate_component(HemisphereLight2, "HemisphereLight2").$$render($$result, {}, {}, {})}` : `<h1>This page does not exist... yet</h1>`}`}`}`}`}`}`}`;
});
export { Sketches as S };
