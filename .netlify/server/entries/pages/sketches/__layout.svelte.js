...
var import_sketchesData = __toESM(require("../../endpoints/sketches/sketchesData.js"));
...
const _layout = (0, import_index_6c951edd.c)(($$result, $$props, $$bindings, slots) => {
  $$result.css.add(css);
  return `<div class="${"wrapper svelte-fcr9jz"}"><div class="${"side-menu-wrapper svelte-fcr9jz"}">${(0, import_index_6c951edd.v)(import_global_8795b219.S, "SideMenu").$$render($$result, { sketchesData: import_sketchesData.default, sketchType: "sketches" }, {}, {})}</div>
